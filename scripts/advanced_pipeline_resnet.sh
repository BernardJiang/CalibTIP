...
sh scripts/adaquant.sh resnet resnet50 4 8 True resnet_adaquant.piano.kdp530.scaled.w4.onnx.json
sh scripts/adaquant.sh resnet resnet50 8 8 True resnet_adaquant.piano.kdp530.scaled.w8.onnx.json
